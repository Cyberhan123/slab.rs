...
vi.mock('@/pages/image/hooks/use-image-model-preparation', () => ({
  useImageModelPreparation: vi.fn<() => unknown>(() => ({
    ...
    prepareSelectedModel: vi.fn<() => Promise<string>>().mockResolvedValue('/path/to/model'),
...
function createImageViewModel(overrides = {}) {
  return {
    ...
    handleDimensionPreset: createVoidMock(),
