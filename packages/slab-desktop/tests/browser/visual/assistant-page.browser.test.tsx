...
const mocks = vi.hoisted(() => {
  ...
  const harnessConversation = {
    ...
    modelLoad: null,
    planMode: false,
    restoredMessages: [] as ConversationState["restoredMessages"],
    ...
    backgroundTasks: [] as ConversationState["backgroundTasks"],
    subagentTasksByTaskId: new Map<string, ConversationState["subagentTasksByTaskId"] extends ReadonlyMap<string, infer V> ? V : never>(),
    subagentChildItemsByChildId: new Map<string, ConversationState["subagentChildItemsByChildId"] extends ReadonlyMap<string, infer V> ? V : never>(),
    liveTextByItemId: new Map<string, ConversationState["liveTextByItemId"] extends ReadonlyMap<string, infer V> ? V : never>(),
    turnStartSeq: 0,
    notifyPaneDetachedMidRun: vi.fn<() => void>(),
