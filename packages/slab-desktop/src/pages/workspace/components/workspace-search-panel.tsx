...
type WorkspaceSearchPanelProps = {
  ...
  fetching: boolean
  query: string
  results: WorkspaceTextSearchFileMatch[]
  truncated: boolean
    ...
    <div className="flex h-full min-h-0 flex-col gap-2">
      <div className="relative px-1">
        ...
        <input
          ...
          placeholder={t("pages.workspace.textSearch.placeholder")}
          aria-label={t("pages.workspace.textSearch.placeholder")}
        />
        {fetching ? (
          ...
          <button
            ...
            aria-label={t("pages.workspace.textSearch.clear")}
        ...
        {hasQuery ? (
          results.length > 0 ? (
            ...
            <div className="flex h-full min-h-[180px] items-center justify-center px-4 text-center text-sm text-muted-foreground">
              {fetching ? t("pages.workspace.tree.loading") : t("pages.workspace.textSearch.empty")}
            </div>
          )
        ) : null}
      </div>
