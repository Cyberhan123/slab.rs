...
export default function Ansi(props: Props): React.ReactElement {
...
function fixBackspace(txt: string) {
  ...
  do {
    ...
    // eslint-disable-next-line no-control-regex -- \x08 (backspace) handling is intentional, mirroring Jupyter classic
    tmp = txt.replace(/[^\n]\x08/gm, "");
