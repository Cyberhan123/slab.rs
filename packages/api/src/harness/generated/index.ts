 ...
 */
export type AgentThreadStatus = "pending" | "running" | "interrupting" | "interrupted" | "completed" | "errored" | "shutdown";
...
// ── JsonRpcErrorBody ──
export type JsonRpcErrorBody = { code: bigint, data?: JsonValue, message: string, };

// ── JsonRpcErrorResponse ──
/**
 * A response to a request that indicates an error occurred.
 */
export type JsonRpcErrorResponse = { jsonrpc: "2.0", error: JsonRpcErrorBody, id: RequestId, };
 ...
 */
export type JsonRpcRequest = { jsonrpc: "2.0", id: RequestId, method: string, params?: unknown, 
/**
 ...
 */
export type JsonRpcResponse = { jsonrpc: "2.0", id: RequestId, result: JsonValue, };
...
// ── W3cTraceContext ──
export type W3cTraceContext = { traceparent: string, tracestate?: string, };
