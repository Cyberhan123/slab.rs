...
export function StatusBadge({
  ...
  if (status === 'ready') {
    return (
      <StatusPill status="success" className={cn(sharedClassName, 'text-success', className)}>
  ...
  if (status === 'downloading') {
    return (
      <StatusPill status="info" className={cn(sharedClassName, 'text-primary', className)}>
