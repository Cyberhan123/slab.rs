...
export function buildSlabMonacoTheme(mode: WorkspaceThemeMode): Monaco.editor.IStandaloneThemeData {
  ...
  return {
    ...
    rules: [
      ...
      { token: "keyword", foreground: token("--primary", fallback.brandTeal) },
    ...
    colors: {
      "editor.background": css("--card", fallback.background),
      "editor.foreground": css("--foreground", fallback.foreground),
      "editor.lineHighlightBackground": css("--secondary", fallback.surfaceSoft),
      "editor.selectionBackground": css("--accent", fallback.selection),
      "editorCursor.foreground": css("--primary", fallback.brandTeal),
      "editorGutter.background": css("--card", fallback.background),
      ...
      "scrollbarSlider.hoverBackground": css("--accent", fallback.selection),
    },
  }
}
