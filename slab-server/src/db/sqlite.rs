...
use super::{ChatMessage, ChatSession, ConfigStore, MessageStore, RequestRecord, RequestStore, SessionStore, TaskRecord, TaskStore};
...
impl TaskStore for SqliteStore {
    ...
    async fn list_tasks(&self, task_type: Option<&str>) -> Result<Vec<TaskRecord>, sqlx::Error> {
        let rows: Vec<(String, String, String, Option<String>, Option<String>, Option<String>, Option<i64>, String, String)> =
