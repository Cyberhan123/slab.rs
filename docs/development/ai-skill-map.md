...
- Plugin package and bridge work
  Start in `plugins/**`, `packages/slab-desktop/src/pages/plugins/**`, `packages/slab-desktop/src/lib/plugin-host-bridge.ts`, `packages/api/**`, `packages/slab-plugin-sdk/**`, `packages/slab-plugin-ui/**`, and `bin/slab-app/src-tauri/src/plugins/**`.
