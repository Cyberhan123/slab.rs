...
if TYPE_CHECKING:
    from ..models.image_generation_request_data import ImageGenerationRequestData
    from ..models.image_generation_result_data import ImageGenerationResultData
    from ..models.task_progress_response import TaskProgressResponse


T = TypeVar("T", bound="ImageGenerationTaskResponse")


@_attrs_define
class ImageGenerationTaskResponse:
    """
    Attributes:
        backend_id (str):
        created_at (str):
        ...
        model_path (str):
        prompt (str):
        request_data (ImageGenerationRequestData):
        requested_count (int):
        status (TaskStatus):
        task_id (str):
        task_type (str):
        ...
        primary_image_url (None | str | Unset):
        progress (None | TaskProgressResponse | Unset):
        reference_image_url (None | str | Unset):
        result_data (ImageGenerationResultData | None | Unset):
    """
    ...
    primary_image_url: None | str | Unset = UNSET
    progress: None | TaskProgressResponse | Unset = UNSET
    reference_image_url: None | str | Unset = UNSET
    result_data: ImageGenerationResultData | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        primary_image_url: None | str | Unset
        if isinstance(self.primary_image_url, Unset):
            primary_image_url = UNSET
        else:
        ...
        if isinstance(self.result_data, Unset):
            result_data = UNSET
        elif isinstance(self.result_data, ImageGenerationResultData):
        ...
        if primary_image_url is not UNSET:
            field_dict["primary_image_url"] = primary_image_url
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        request_data = ImageGenerationRequestData.from_dict(d.pop("request_data"))

        requested_count = d.pop("requested_count")
        ...
        def _parse_primary_image_url(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        primary_image_url = _parse_primary_image_url(d.pop("primary_image_url", UNSET))
        ...
        def _parse_result_data(
            data: object,
        ) -> ImageGenerationResultData | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        image_generation_task_response = cls(
            backend_id=backend_id,
            created_at=created_at,
            height=height,
            image_urls=image_urls,
        ...
        image_generation_task_response.additional_properties = d
        return image_generation_task_response
