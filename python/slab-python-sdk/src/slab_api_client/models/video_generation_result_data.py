...
T = TypeVar("T", bound="VideoGenerationResultData")


@_attrs_define
class VideoGenerationResultData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        video_generation_result_data = cls(
            video_path=video_path,
        )

        video_generation_result_data.additional_properties = d
        return video_generation_result_data
