...
T = TypeVar("T", bound="TranscribeVadRequest")


@_attrs_define
class TranscribeVadRequest:
    """
    Attributes:
        enabled (bool | Unset): Enable VAD during whisper transcription.
        max_speech_duration_s (float | None | Unset): Maximum speech segment duration in seconds before auto-splitting.
        min_silence_duration_ms (int | None | Unset): Minimum silence duration in milliseconds used to split segments.
        min_speech_duration_ms (int | None | Unset): Minimum speech segment duration in milliseconds.
        model_path (None | str | Unset): Absolute path to the VAD model file.
        samples_overlap (float | None | Unset): Overlap in seconds between adjacent VAD segments.
        speech_pad_ms (int | None | Unset): Padding in milliseconds added around each detected speech segment.
        threshold (float | None | Unset): Probability threshold used to classify speech.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transcribe_vad_request.additional_properties = d
        return transcribe_vad_request
