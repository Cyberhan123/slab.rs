...
from ..models.image_mode import ImageMode
...
class ImageGenerationRequest:
    ...
    Attributes:
        ...
        clip_skip (int | None | Unset): CLIP skip layers (default `0` = auto).
        eta (float | None | Unset): DDIM eta (default `0.0`).
        guidance (float | None | Unset): Distilled guidance (Flux/SD3 models, default `3.5`).
        height (int | Unset): Output image height in pixels (default `512`).
        init_image (None | str | Unset): Init image as a base64-encoded data URI (`data:image/png;base64,...`).
            Required when `mode` is `img2img`.
        mode (ImageMode | Unset): Generation mode.
        ...
        negative_prompt (None | str | Unset): Negative text prompt (things to avoid in the generated image).
        sample_method (None | str | Unset): Sampling method (`"euler"`, `"euler_a"`, `"lcm"`, etc., `"auto"`).
        scheduler (None | str | Unset): Sigma schedule (`"discrete"`, `"karras"`, etc., `"auto"`).
        seed (int | None | Unset): RNG seed (`-1` = random, default `42`).
        steps (int | None | Unset): Number of denoising steps (default `20`).
        strength (float | None | Unset): Init-image influence strength for img2img (0–1, default `0.75`).
        width (int | Unset): Output image width in pixels (default `512`).
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mode: ImageMode | Unset
        if isinstance(_mode, Unset):
            mode = UNSET
        else:
            mode = ImageMode(_mode)
