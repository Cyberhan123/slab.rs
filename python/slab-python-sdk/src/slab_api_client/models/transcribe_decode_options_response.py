...
T = TypeVar("T", bound="TranscribeDecodeOptionsResponse")


@_attrs_define
class TranscribeDecodeOptionsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transcribe_decode_options_response = cls(
        ...
        transcribe_decode_options_response.additional_properties = d
        return transcribe_decode_options_response
