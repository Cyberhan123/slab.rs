...
T = TypeVar("T", bound="PluginSettingsContribution")
...
class PluginSettingsContribution:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        plugin_settings_contribution = cls(
            id=id,
            schema=schema,
            title=title,
            title_key=title_key,
        ...
        plugin_settings_contribution.additional_properties = d
        return plugin_settings_contribution
