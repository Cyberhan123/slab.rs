...
export const executableSmokeOperations = [
  ...
  { method: "get", path: "/v1/agents/rollouts" },
  { method: "get", path: "/v1/agents/rollouts/{thread_id}/lines" },
  { method: "get", path: "/v1/agents/rollouts/{thread_id}/timeline" },
  { method: "get", path: "/v1/agents/rollouts/{thread_id}/trace" },
