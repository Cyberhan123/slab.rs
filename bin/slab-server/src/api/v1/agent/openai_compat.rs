...
use slab_proto::openai::{
    ...
    CreateFileOperationType, CustomToolCall, CustomToolCallInputDeltaType, CustomToolCallType,
    DeleteFileOperationType, FunctionCallStatus, FunctionShellAction, FunctionShellCall,
    ...
    UpdateFileOperationType, WebSearchCompletedType, WebSearchInProgressType,
    WebSearchSearchingType,
};
use slab_proto::openai::{
    CommonOutputType, ContentPartAddedType, ContentPartDoneType, FuncArgsDeltaType,
    FuncArgsDoneType, FunctionToolCall, FunctionToolCallStatus, ModelIdsResponses, OutputContent,
    OutputItem, OutputItemAddedType, OutputItemDoneType, OutputMessage, OutputMessageContent,
    OutputMessageRole, OutputTextContent, ReasoningItem, ReasoningItemType,
    ReasoningSummaryPartAddedType, ReasoningSummaryPartDoneType, ReasoningSummaryTextDeltaType,
    ReasoningSummaryTextDoneType, Response, ResponseCompletedEvent, ResponseCompletedType,
    ResponseContentPartAddedEvent, ResponseContentPartDoneEvent, ResponseCreatedEvent,
    ResponseCreatedType, ResponseCustomToolCallInputDeltaEvent, ResponseErrorEvent,
    ResponseFailedEvent, ResponseFailedType, ResponseFunctionCallArgumentsDeltaEvent,
    ResponseFunctionCallArgumentsDoneEvent, ResponseInProgressEvent, ResponseInProgressType,
    ResponseObject, ResponseOutputItemAddedEvent, ResponseOutputItemDoneEvent,
    ...
    ResponseTextDeltaEvent, ResponseTextDoneEvent, ResponseUsage, ResponsesServerEvent,
    ServiceTier, Status, SummaryTextContent, SummaryTextContentType, SummaryTextType,
    TextDeltaType, TextDoneType,
};
...
// `AdapterInput` is re-exported above; the local definition was removed.
