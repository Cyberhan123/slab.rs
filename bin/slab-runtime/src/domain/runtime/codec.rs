...
mod tests {
    ...
    use slab_types::{
        ...
        CandleWhisperLoadConfig, Capability, DriverLoadStyle, ModelSource, OnnxLoadConfig,
        RawImageInput, WhisperDecodeOptions, WhisperVadOptions, WhisperVadParams,
    };
    ...
    fn make_driver(
        ...
        use crate::domain::runtime::dispatch::ResolvedDriver;
        ResolvedDriver {
