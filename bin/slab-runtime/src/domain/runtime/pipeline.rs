...
mod tests {
    ...
    use super::*;
    use crate::domain::runtime::{Runtime, TaskState};
    use crate::domain::runtime::DriverResolver;
    use slab_runtime_core::backend::{
        BackendReply, BackendRequestKind, ManagementEvent, RequestRoute, ResourceManager,
        ResourceManagerConfig, StreamChunk,
    };
        ...
        resource_manager.register_backend(backend_id, move |shared_rx, _control_tx| {
            ...
            tokio::spawn(async move {
                ...
                loop {
                    ...
                    let route = req.route().expect("backend request should use a known route");
                    match req.kind {
                        ...
                        BackendRequestKind::Inference => {
                            ...
                            match &backend {
                                ...
                                MockBackend::Embedding { input_name } => match route {
                                    RequestRoute::Inference => {
    ...
    fn test_runtime() -> Runtime {
        ...
        Runtime::new(Orchestrator::start(resource_manager, 32), resolver)
    }
