...
use crate::infra::backends::ggml::internal::engine::ggml::llama::adapter::{
...
impl LlamaWorker {
    ...
    async fn handle_inference_stream(
        ...
        match engine.dispatch_inference_stream(request, cancel_rx).await {
            ...
            Err(error) => {
                let error: crate::infra::backends::ggml::internal::engine::EngineError = error;
...
mod tests {
    ...
    use crate::infra::backends::ggml::internal::engine::ggml::llama::adapter::infer_add_assistant_prompt;
