...
use crate::infra::backends::candle::internal::engine::candle::llama::adapter::CandleLlamaEngine;
use crate::infra::backends::candle::internal::engine::candle::llama::errors::SessionId;
...
impl CandleLlamaWorker {
    ...
    async fn handle_inference_stream(
        ...
        tokio::spawn(async move {
            use crate::infra::backends::candle::internal::engine::candle::llama::errors::StreamChunk as CandleChunk;
