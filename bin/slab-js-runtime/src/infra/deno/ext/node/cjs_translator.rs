...
pub enum CjsAnalysis {
    ...
    /// The module was CJS.
    Cjs { exports: Vec<String>, reexports: Vec<String> },
}
...
impl From<ExtNodeCjsAnalysis<'_>> for CjsAnalysis {
    fn from(analysis: ExtNodeCjsAnalysis) -> Self {
        match analysis {
            ...
            ExtNodeCjsAnalysis::Cjs(analysis) => {
                CjsAnalysis::Cjs { exports: analysis.exports, reexports: analysis.reexports }
            }
        }
    }
}
impl From<deno_ast::CjsAnalysis> for CjsAnalysis {
    fn from(analysis: deno_ast::CjsAnalysis) -> Self {
        Self::Cjs { exports: analysis.exports, reexports: analysis.reexports }
    }
}
...
impl RustyCjsCodeAnalyzer {
    pub fn new(fs: deno_fs::FileSystemRc, cjs_tracker: Arc<RustyResolver>) -> Self {
        Self { fs, cache: RefCell::new(HashMap::new()), cjs_tracker }
    }
    ...
    fn inner_cjs_analysis(
        ...
        if media_type == MediaType::Json {
            return Ok(CjsAnalysis::Cjs { exports: vec![], reexports: vec![] });
        }
        ...
        let is_cjs = self.cjs_tracker.is_cjs(parsed_source.specifier(), media_type, is_script);
