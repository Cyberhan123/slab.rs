...
pub enum GGMLLogLevel {
    ...
    Warn = slab_parakeet_sys::ggml_log_level_GGML_LOG_LEVEL_WARN,
    Error = slab_parakeet_sys::ggml_log_level_GGML_LOG_LEVEL_ERROR,
    Debug = slab_parakeet_sys::ggml_log_level_GGML_LOG_LEVEL_DEBUG,
    Cont = slab_parakeet_sys::ggml_log_level_GGML_LOG_LEVEL_CONT,
...
impl From<ggml_log_level> for GGMLLogLevel {
    fn from(level: ggml_log_level) -> Self {
        match level {
            slab_parakeet_sys::ggml_log_level_GGML_LOG_LEVEL_NONE => GGMLLogLevel::None,
            slab_parakeet_sys::ggml_log_level_GGML_LOG_LEVEL_INFO => GGMLLogLevel::Info,
            slab_parakeet_sys::ggml_log_level_GGML_LOG_LEVEL_WARN => GGMLLogLevel::Warn,
            slab_parakeet_sys::ggml_log_level_GGML_LOG_LEVEL_ERROR => GGMLLogLevel::Error,
            slab_parakeet_sys::ggml_log_level_GGML_LOG_LEVEL_DEBUG => GGMLLogLevel::Debug,
            slab_parakeet_sys::ggml_log_level_GGML_LOG_LEVEL_CONT => GGMLLogLevel::Cont,
