...
pub enum ResponsesServerEvent {
    ...
    ResponseShellCallCommandAddedEvent(Box<models::ResponseShellCallCommandAddedEvent>),
    ResponseShellCallCommandDeltaEvent(Box<models::ResponseShellCallCommandDeltaEvent>),
    ResponseShellCallCommandDoneEvent(Box<models::ResponseShellCallCommandDoneEvent>),
    ResponseShellCallOutputContentDeltaEvent(Box<models::ResponseShellCallOutputContentDeltaEvent>),
    ResponseShellCallOutputContentDoneEvent(Box<models::ResponseShellCallOutputContentDoneEvent>),
