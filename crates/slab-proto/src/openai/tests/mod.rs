...
const EMBEDDINGS_RESPONSE: &str = r#"{"data":[{"index":0,"embedding":[0.0125],"object":"embedding"}],"model":"string","object":"list","usage":{"prompt_tokens":0,"total_tokens":0}}"#;
...
const RESPONSE_ERROR_EVENT: &str = r#"{"type":"error","sequence_number":7,"error":{"code":null,"message":"stream aborted","param":null,"type":"server_error"}}"#;
