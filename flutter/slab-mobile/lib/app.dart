...
class SlabApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      ...
      child: BlocBuilder<LocaleCubit, SlabLanguagePreference>(
        builder: (context, preference) {
          ...
          return MaterialApp.router(
            ...
            routerConfig: router,
            // auto keeps `locale` null so platform resolution stays live;
            // the callback ports normalizeLanguage (zh-TW/HK/MO → en-US).
            locale: localeCubit.localeOverride,
            ...
            localeResolutionCallback: (deviceLocale, supported) {
              final tag = SlabCatalog.resolveLocale(deviceLocale?.toString());
              return supported.firstWhere(
                (locale) => locale.toLanguageTag() == tag,
