...
impl IdxFile {
    ...
    fn parse_line(line_num: usize, s: String) -> Result<Vec<IdxFilePart>> {
        ...
        (
            ...
            .map(
                |(ws1, s1, ws2, timestamp_str, s2, _): (
                 ...
                 -> Result<Vec<IdxFilePart>> {
                    ...
                    result.push(IdxFilePart::Timestamp(Self::parse_timestamp(
                        line_num,
            ...
            .parse(s.as_str())
            .map_err(|e| IdxLineParseError { line_num, msg: parse_error_to_string(e) })?
            .0
    }
    ...
    fn parse_timestamp(line_num: usize, s: &str) -> Result<TimePoint> {
        (
            ...
            .map(|(hours, _, mins, _, secs, _, msecs, _)| {
