...
use crate::dispatch::{DriverLoadStyle, ResolvedInvocation};
use crate::spec::{
    ...
    ModelFamily, ModelSource, ModelSpec, TextGenerationChunk, TextGenerationRequest,
    ...
    if let Some(images) = value.get("images").and_then(Value::as_array) {
        return images
            ...
            .map(|entry| match entry {
                Value::String(b64) => base64::engine::general_purpose::STANDARD
                    .decode(b64)
