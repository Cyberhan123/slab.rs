...
- Plugin manifests now support `manifestVersion: 1` with runtime assets, host-controlled `contributes.*`, `permissions.*`, and agent capabilities. MCP is a future export target for capabilities, not the plugin runtime itself.
